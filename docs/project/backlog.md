...
>
> **다음 버전 v1.1.0(알림 중심)의 단일 기준은 [`docs/project/milestones-v1.1.md`](./milestones-v1.1.md).**
> 아래 티켓 중 HYDRA-024(알림 환경설정)·027(Settings 내비)·010(라벨 관리 UI)·011(서버 필터)·013(체크리스트)·030~033·029는
> v1.0.0/v1.1.0 워크스트림으로 편입됐다. HYDRA-016(간트/번다운)·019a/b(Slack·GitHub 동기화)·021(마감일)은 **v1.2** 후보.
